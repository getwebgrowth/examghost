            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center max-w-4xl mx-auto mb-16 relative z-30">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <button className="px-8 py-3.5 bg-primary hover:bg-blue-700 text-white rounded-full font-bold transition-all shadow-lg shadow-blue-500/30 flex items-center justify-center gap-2 transform hover:-translate-y-0.5 hover:shadow-xl hover:shadow-blue-500/40">
                            Add to Chrome - It&apos;s Free <ArrowRight className="w-[18px] h-[18px]" />
                        </button>
                    </div>
                </div>
                ...
                {/* ============================== */}
                <div className="relative w-full max-w-[1000px] mx-auto z-20 mt-12 mb-12 group">
                    {/* Hover glow */}
                    ...
                    <div className="bg-white/80 rounded-2xl p-1.5 sm:p-2 border border-slate-200/80 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.12),0_0_0_1px_rgba(0,0,0,0.02)] relative backdrop-blur-xl">
                        ...
                        <div className="rounded-xl border border-slate-200 shadow-sm relative bg-white flex flex-col overflow-hidden">
                            ...
                            <div className="flex flex-col md:flex-row h-auto md:h-[460px]">
                                ...
                                {/* -------- SIDEBAR -------- */}
                                <div className="hidden md:flex w-[220px] bg-gradient-to-b from-white to-[#fafbfc] border-r border-slate-100 p-5 flex-col shrink-0">
                                    {/* Brand */}
                                ...
                                <div className="flex-1 p-6 sm:p-8 bg-[#fafbfc] relative overflow-visible flex flex-col">
                                    ...
                                    {/* Quiz Card */}
                                    <div className="bg-white border border-slate-200 rounded-xl p-6 sm:p-7 shadow-[0_2px_8px_rgba(0,0,0,0.04)] max-w-[560px] relative transition-all duration-300">
                                        {/* Q Header */}
                                        ...
                                        <div className="text-[15px] font-bold text-slate-800 mb-6 tracking-tight leading-snug">
                                        ...
                                        <div className="space-y-3 relative">
                                            ...
                                            <div className="grid grid-cols-[1fr_1.5fr] gap-3 items-center">
                                            ...
                                            <div className="grid grid-cols-[1fr_1.5fr] gap-3 items-center relative z-20">
                                                <div className="font-semibold text-[13px] text-slate-700 bg-slate-50 p-3 rounded-lg border border-slate-100 text-center">
                                                    H₂O
                                                </div>
                                                ...
                                                {/* ===== FLOATING TOOLTIP ===== */}
                                                <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-[calc(100%+20px)] w-[220px] z-50 hidden sm:block">
                                        ...
                                        <div className="mt-5 pt-4 border-t border-slate-100 flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                                <div className="h-1 w-32 bg-slate-100 rounded-full overflow-hidden">
                                                    <div className="w-[75%] h-full bg-emerald-500 rounded-full transition-all" />
                                                </div>
