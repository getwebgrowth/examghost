        ...
        <section id="features" className="py-16 md:py-20 lg:py-24 bg-[#2563eb] relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="md:hidden space-y-3 lg:hidden">
                    {steps.map((step, idx) => (
                        <div key={idx} className="border border-white/10 rounded-2xl overflow-hidden bg-white shadow-lg transition-all duration-300 relative z-20">
                            <button
                    ...
                    {steps.map((step, idx) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* Visual Container */}
                                <div className="flex-1 h-[260px] lg:h-[300px] rounded-2xl overflow-hidden border border-slate-200/60 shadow-inner bg-[#f8fafc] w-full relative">
                                    {step.visual}
                                </div>
                            </div>
                        );
