            ...
            <section className="pt-32 pb-20 relative overflow-hidden bg-[#FAFAFA] border-b border-slate-100">
                ...
                <div className="max-w-6xl mx-auto px-4 relative z-10 text-center">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-slate-200/60 shadow-sm mb-6">
                        ...
                        <span className="text-[11px] font-bold text-slate-800 tracking-widest uppercase">The #1 Quietly Alternative</span>
                    </div>
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-[4.5rem] font-extrabold text-slate-900 tracking-tight leading-[1.1] mb-6 max-w-4xl mx-auto">
                        Stop relying on <br className="hidden md:block" />
                        ...
                        <div className="bg-rose-50 rounded-[2rem] p-8 md:p-10 border border-rose-100 relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h3 className="text-2xl font-bold text-slate-900">Quietly's Flaw</h3>
                                </div>
                                <p className="text-slate-600 leading-relaxed mb-8">
                                    Quietly and similar entry-level extensions use standard content scripts. Whenever they scan your quiz or overlay buttons, they <strong className="text-rose-600">alter the DOM</strong>.
                                    Canvas actively hashes the DOM to find these unauthorized scripts.
                                </p>
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-white rounded-xl p-4 border border-blue-100 shadow-sm flex gap-3 items-start hover:shadow-md transition-shadow">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-slate-800 text-sm">Total Focus Protection</h4>
                                            <p className="text-xs text-slate-500 mt-1.5">Programmatically overrides document visibility and blur events securely.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div className="bg-slate-50">
                ...
                <section className="py-20 bg-white border-t border-slate-100">
                    <div className="max-w-4xl mx-auto px-4">
                        <h2 className="text-3xl font-extrabold text-slate-900 mb-8 text-center tracking-tight">Quietly vs ExamGhost: Detailed Analysis</h2>
                        ...
                        <div className="space-y-12">
                            <div>
                                <h3 className="text-2xl font-bold text-slate-800 mb-4 flex items-center gap-3">
                                    ...
                                    Is Quietly Safe to Use on Canvas?
                                </h3>
                            ...
                            <div>
                                ...
                                <p className="text-slate-600 leading-relaxed mb-4">
                                    One of the easiest ways students get flagged is when a portal detects a "blur" event—meaning you clicked outside the test window or switched tabs. Basic tools like Quietly often fail to suppress these browser-level events.
                                </p>
                                <p className="text-slate-600 leading-relaxed">
                                    <strong>The ExamGhost Advantage:</strong> We aggressively patch these leaks. ExamGhost actively overrides `document.visibilityState` and intercepts `window.onblur` event listeners. This guarantees that your testing portal continuously believes you have the active window safely focused, even when interacting with the AI.
                                </p>
                            </div>
